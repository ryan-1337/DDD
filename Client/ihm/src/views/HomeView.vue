...
-->
  <div
    ...
    <div class="relative z-20 max-w-screen-lg mx-auto grid grid-cols-12 h-full items-center">
      <div class="col-span-6">
        ...
        <h1 class="text-stone-100 text-base">Bienvenue sur XYZ Hotel</h1>
        <p class="text-stone-100 text-base">Découvrez nos offres exceptionnelles et réservez votre séjour dès aujourd'hui.</p>
        <router-link to="/" class="text-stone-100 text-base">Voir la liste des clients</router-link>
        <router-link to="/create-client" class="text-stone-100 text-base">Créer un nouveau client</router-link>
        <button
  ...
  <div class="bg-[#f7d0b6] py-20">
    <div class="max-w-screen-lg mx-auto flex justify-between items-center">
      <div class="max-w-xl">
        <h2 class="font-black text-sky-950 text-3xl mb-4">As the leading experts in this field, we're in over 90 countries
        </h2>
        <p class="text-base text-sky-950">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
      ...
      <div
        ...
        <div class="relative z-20 pl-12">
          ...
          <p class="text-white text-sm">
            Purus in massa tempor nec. Magna etiam tempor orci eu lobortis elementum nibh tellus molestie. Faucibus ornare
            suspendisse sed nisi lacus sed viverra. Diam in arcu cursus euismod quis viverra nibh cras pulvinar.
          </p>
          <button
            class="mt-8 text-white uppercase py-3 text-sm px-10 border border-white hover:bg-white hover:bg-opacity-10">Talk
            with expert</button>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-2 max-w-screen-lg mx-auto">
      ...
      <div
        ...
        <div class="relative z-20 pl-12">
          ...
          <button
            class="mt-8 text-sky-950 uppercase py-3 text-sm px-10 border border-sky-950 hover:bg-white hover:bg-opacity-10">Talk
            with expert</button>
        </div>
      </div>
